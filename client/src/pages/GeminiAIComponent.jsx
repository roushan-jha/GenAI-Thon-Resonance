...
const GeminiAIComponent = () => {
  ...
  return (
    <motion.div 
      ...
      className="w-[100vw] h-auto overflow-y-auto flex flex-col justify-center items-center bg-gradient-to-br from-blue-500 to-indigo-700 text-white p-10 rounded-lg shadow-2xl"
    >
      <motion.h2 
